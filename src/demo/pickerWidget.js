...
import {Animated, Dimensions, Easing, Picker, StyleSheet, Text, View} from "react-native";
                ...
                <View style={styles.container}>
                    ...
                    <Animated.View style={[styles.tip, {
                        ...
                        <Picker
                            ...
                            {this.options.map((aOption) => <Picker.Item color='#b5b9be' label={aOption} value={aOption}
                                                                        key={aOption}/>)}
                        </Picker>
                    </Animated.View>
                </View>
